...
- **The Fixer.** Paste 2-6 hex codes. It diagnoses violations against the laws by name, rebuilds the palette with roles assigned, shows before/after, and can load the result into the Engine.
